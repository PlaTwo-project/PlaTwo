...
SavedGame::SavedGame( GameName game_name, int host_id, int guest_id,int board_size, int time_limit, int elapsed_time, int host_elapsed_time, int guest_elapsed_time, const QString &state_data)
    : game_name(game_name), host_id(host_id), guest_id(guest_id), board_size(board_size), time_limit(time_limit),
    elapsed_time(elapsed_time),host_elapsed_time(host_elapsed_time), guest_elapsed_time(guest_elapsed_time), state_data(state_data) {}
