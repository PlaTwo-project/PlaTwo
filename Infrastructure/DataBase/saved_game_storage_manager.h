...
public:
    ...
    void saveOrUpdateGame(GameName game_name, int host_id, int guest_id, int board_size, int time_limit, int elapsed_time,int host_elapsed, int guest_elapsed, const QString &state_data);
